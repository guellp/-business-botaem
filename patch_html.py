...
html_path = r"c:\Users\bwj10\OneDrive\바탕 화면\AI_Agents\다니 디자인 에이전트\사업 Botaem 홈페이지 프로젝트\index.html"
...
if os.path.exists(html_path):
    ...
    content, count = re.subn(pattern, r'\g<1>사업 Botaem 이웃들\g<2>', content)
